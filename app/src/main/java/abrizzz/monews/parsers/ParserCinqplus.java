...
public class ParserCinqplus extends AsyncTask<Void,Void,Void>{
    ...
    public ParserCinqplus(Activity a)
    {
        this.activity = a;
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        try{
            URL u = new URL(activity.getString(R.string.cinqplus_source));
                    ...
                    if(xpp.getName().equals(item))
                    {
                        ...
                        while(!done) {
                            ...
                            if (xpp.getName().equals(title)) {
                                ...
                                if (tmp != null)
                                {
                                    Matcher m = linkPattern.matcher(Html.escapeHtml(tmp));
                                    if(m.find())
                                    {
                        ...
                        newItem.setSource(activity.getResources().getString(R.string.cinqplus));
            ...
            NewsItems.getSingletonInstance().addCinqplusList(tmpList);
        }
        catch(ConnectException e)
        {
            e.printStackTrace();
            ((MainActivity)activity).cinqplusDone = true;
        }
